    ...
    <div class="max-w-5xl mx-auto space-y-12">
      ...
      <div>
        <div class="flex items-center gap-3 mb-6">
          <h2 class="text-lg font-semibold text-white">Find me on social media</h2>
      ...
      <div>
        <div class="flex items-center gap-3 mb-6">
          <h2 class="text-lg font-semibold text-white">Or send me a message</h2>
          <span class="h-[1px] flex-1 bg-gradient-to-r from-[#659cf0]/40 to-transparent rounded-full"></span>
        </div>
      ...
      contacts: [
        {
          ...
          link: 'mailto:samuelbenedicto@gmail.com',
